          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <button type="button" className="text-xs forum-link">Forgot your password?</button>
              </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="stay-logged" className="text-sm text-muted-foreground cursor-pointer">Stay logged in</label>
            </div>
            ...
            <div className="text-center pt-4 border-t border-border">
              <p className="text-sm text-muted-foreground">
                ...
                <Link to="/register" className="forum-link">Register now</Link>
              </p>
            </div>
          </form>
        </div>
